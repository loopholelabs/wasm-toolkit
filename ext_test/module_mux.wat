...
(module
  ...
  (type (func (param i64) (param i64) (param i32) (param i32) (result i64)))

  (import "env" "ext_mux" (func $ext_mux (type 1)))
  ...
  (func $fetch_New (param i64) (param i32) (param i32) (result i64)
    i64.const 0
    local.get 0
    local.get 1
    local.get 2
  ...
  (func $fetch_HttpConnector_Fetch (param i64) (param i32) (param i32) (result i64)
    i64.const 1
    local.get 0
    local.get 1
    local.get 2
...
;;  (export "ext_5c7d22390f9101d459292d76c11b5e9f66c327b1766aae34b9cc75f9f40e8206_Resize" (func $fetch_resize))
  (func $ext_resize (param i64) (param i32) (result i32)
    block
      local.get 0
      i64.const 0
      i64.eq
      br_if 0
      unreachable     ;; Only support ID 0
    end
    local.get 1
    call $fetch_resize
  )
...
;; Resize the fetch ext buffer
  ...
  (export "ext_resize" (func $ext_resize))
